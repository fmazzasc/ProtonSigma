...
data_file = ROOT.TFile(f"results/kstar_sigma_proton_analysis{suffix_mc}{suffix_bantib}.root")
kstar_histo = data_file.Get("hKstarData")
kstar_histo.SetDirectory(0)
## draw with pe
kstar_histo.SetMarkerStyle(20)
# kstar_histo.Rebin(2) 
em_file = ROOT.TFile(f"results/kstar_sigma_proton_analysis{suffix_mc}_ME{suffix_bantib}.root")
...
outfile = ROOT.TFile(f"results/kstar_ratio_sigma_proton{suffix_mc}{suffix_bantib}.root", "RECREATE")
ratio_histo.Write()
